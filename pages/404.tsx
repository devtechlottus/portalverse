...
const NotFound: NextPageWithLayout = _ => {
  return <>
    ...
    <section className="w-full flex font-Poppins justify-center items-center flex-col mx-auto">
      ...
      <Link href={'/'}>
        <a className="py-4 px-8 w-p:w-full w-p:text-center font-bold w-p:text-5 bg-black rounded-lg text-white text-base mb-13.75 w-t:mb-12 w-p:mb-16.5">Vuelve al inicio</a>
      </Link>
    </section>
  </>
}
