...
const NotFound: NextPage = _ => {
  return <>
    ...
    <section className="w-full flex font-Poppins justify-center items-center flex-col bg-SC-Actions-AC-200 pt-12.5 mx-auto pb-6">
      ...
      <Image src="/images/404.png" alt="error_image" />
