...
const OpenForm: FC<any> = ({ classNames, image, pathThankyou, controls, data }: any) => {
  ...
  return <section className={cn("p-6 shadow-15 bg-white", classNames)}>
    <StepOne data={data} step={30} classNames={cn({ "hidden": step !== 1 })} image={image} onNext={handleNextStep} />
