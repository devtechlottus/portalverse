      ...
      <div style={{"height": data.height}} className={cn(`relative flex border-solid border-2 border-dark w-p:hidden`, classNames)} >
        ...
        <div className= {cn("absolute w-full h-full flex", classNames, {
          ...
          <div className="p-10">
            ...
            <h3 className={cn("font-Nunito font-normal w-d:leading-5 w-t:leading-[17.5px] w-p:leading-[17.5px] w-d:text-base w-t:text-3.5 w-p:text-3.5", classNames, {"text-white": data.overlayDak || data.font === "light"})}>{ data.subtitle }</h3>
            {
