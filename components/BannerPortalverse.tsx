...
const BannerPortalverse: FC<BannerPortalverseComponentData> = memo(({ data: { image, title, subtitle }, classNames }: BannerPortalverseComponentData) => {
  return <div style={{"backgroundImage":`linear-gradient(0deg, rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)), url(${image})`}} className={cn("col-span-12 w-t:col-span-8 w-p:col-span-4 aspect-2/1 bg-cover flex flex-col items-center justify-center p-10", classNames)}>
